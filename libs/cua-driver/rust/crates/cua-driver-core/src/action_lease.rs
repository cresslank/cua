...
//!
//! - `tool::desktop_action_coordinator` — process-wide `Mutex<()>`. Replaced
//!   by this table in a later task.
//! - `tool::active_text_input_pids` — pid-scoped type-text gate; fold into
//!   the app lease.
